...
// import overlay from '../img/me-overlay.svg'
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        return (
        <div className="home" id="outer-container" style={
            {
                backgroundImage: `linear-gradient(rgba(0,0,0,0) 0% , rgba(26,26,26, 0.5) 100%), url(${mePNG})`,
                overlay: 'hidden'
            }
        }>        
                    <div className="home__hero" id="page-wrap" 
                        style={
                            {
                              position: "absolute",
                              top: 0,
                        ...
                        <span>
                        I’m <i>front end web developer</i>
                        </span>
                    </div>
                </div>)
}
...
//   // const txtr = useMemo(() => new THREE.TextureLoader().load(mePNG), [mePNG])
...
//       {/*txtr &&
//         <meshPhongMaterial attach="material" map={txtr} />*/
//     }
//     </mesh>
//   )
// }
...
//      {txtr && <a.sprite scale={[viewport.width, viewport.height, 1]}>
//       <a.spriteMaterial attach="material" map={txtr} transparent  opacity={top.interpolate([0, 200], [1, 0])} position={top.interpolate(top => [0, -1 + top / 200, 0])}/>
//     </a.sprite>}
//     <Background color={top.interpolate([0, scrollMax * 0.25, scrollMax * 0.8, scrollMax], ['#fff', '#247BA0', '#70C1B3', '#f8f3f1'])}/>
